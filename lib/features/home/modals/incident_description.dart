...
Future<String?> showDescriptionInputDialog({
  ...
  // Fallback color if markerDetails is null.
  final Color modalColor = markerDetails?.color ?? Colors.blueGrey;
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: modalColor, width: 1.5), // Border with marker color
              ),
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: modalColor, // Use the marker-specific color.
                    ),
                  ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          cursorColor: modalColor, // Cursor color matches marker theme.
                          ...
                          decoration: InputDecoration(
                            ...
                            focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12.0),
                              borderSide: BorderSide(
                                color: modalColor, // Use the marker-specific color for focus.
                                width: 2.0,
                              ),
                            ),
                          ),
